...
all: HachiDispatch HachiLogin HachiMap
...
HachiMap: core.cpp map.cpp easywsclient/easywsclient.cpp ; $(CC) -o HachiMap core.cpp map.cpp easywsclient/easywsclient.cpp $(CFLAGS) -DMAP_SERVER
